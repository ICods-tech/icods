...
var ChangeFavoriteStatusService = /** @class */ (function () {
    ...
    ChangeFavoriteStatusService.prototype.run = function (userId, qrcodeId) {
        return __awaiter(this, void 0, void 0, function () {
            var qrCode;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getUserById_1.getUserById(userId, this.usersRepository)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, getQRCodeById_1.getQRCodeById(qrcodeId, this.qrcodeRepository)];
                    case 2:
                        qrCode = _a.sent();
                        checkReceivedQRCodeProperties_1.default(qrCode, userId, true);
                        return [4 /*yield*/, this.qrcodeRepository.changeFavoriteStatus(qrCode)];
                    case 3:
                        qrCode = _a.sent();
