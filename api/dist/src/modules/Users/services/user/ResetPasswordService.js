...
var ResetPasswordService = /** @class */ (function () {
    function ResetPasswordService(usersRepository, hashProvider) {
        this.usersRepository = usersRepository;
        this.hashProvider = hashProvider;
    }
    ResetPasswordService.prototype.run = function (id, old_password, password, password_confirmation) {
        return __awaiter(this, void 0, void 0, function () {
            var user, checkPasswords, new_password;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        checkPasswords = _a.sent();
                        if (!checkPasswords) {
                            throw new AppError_1.default('Old Password does not match');
                        }
                        if (password !== password_confirmation) {
                            throw new AppError_1.default('Password confirmation must match new password');
                        }
